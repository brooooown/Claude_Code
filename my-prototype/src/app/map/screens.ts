...
export const screens: Screen[] = [
  ...
  },
  {
    ...
    variants: [
      { id: "indeterminate", label: "Indeterminate Progress", query: "_v=indeterminate" },
      { id: "empty", label: "Empty State", query: "_v=empty" },
    ],
    patterns: [
      {
        id: "linear",
        label: "Linear Progress",
        description: "Traditional horizontal progress bars with different styles and sizes.",
        query: "_p=linear",
      ...
      },
      {
        ...
        description: "Circular progress indicators perfect for compact spaces and status displays.",
        query: "_p=circular",
        group: "Progress Types",
      },
      {
        id: "steps",
        label: "Step Progress",
        description: "Multi-step progress indicators for workflows and processes.",
        query: "_p=steps",
        group: "Progress Types",
      },
      {
        ...
        description: "Loading indicators and spinners for various loading states.",
        query: "_p=loading",
        group: "Progress Types",
      },
    ],
